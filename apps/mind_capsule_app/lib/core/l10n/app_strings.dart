...
class AppStrings {
  ...
  String get premiumSubtitle => _isEn ? 'All features are available' : '全機能をご利用いただけます';
  ...
  String get alreadySavedTitle => _isEn ? 'Already recorded today' : '今日は記録済みです';
  String get alreadySavedSubtitle => _isEn ? 'See you tomorrow 😊' : 'また明日記録しましょう 😊';
  String get timerLabel => _isEn ? '1-min Timer' : '1分タイマー';
  String get timerUsedLabel => _isEn ? '1-min Timer (used today)' : '1分タイマー（本日使用済み）';
  ...
  String get diaryHintTimerOff => _isEn ? 'Turn on the timer to write' : '1分タイマーをONにして書いてください';
  ...
  String get historyEmptySubtitle => _isEn ? 'Record your mood from the Record tab' : '記録タブから今日の気持ちを残しましょう';
  ...
  String statsChartLabel(String label) => _isEn ? '5-Axis Trend ($label)' : '5軸の推移（$label）';
  ...
  String get statsAiButton => _isEn ? 'Analyze this period with AI' : 'この期間をAIで分析';
  String get statsAiLoading => _isEn ? 'Analyzing...' : '分析中...';
  String get statsAiLocked => _isEn ? 'AI analysis (monthly limit reached)' : 'AI分析（今月の上限に達しました）';
  ...
  String get settingsApiKeyDeleted => _isEn ? 'API key deleted' : 'APIキーを削除しました';
  String get settingsApiKeyEmpty => _isEn ? 'Please enter an API key' : 'APIキーを入力してください';
  ...
  String get settingsReminderSubtitle => _isEn ? 'Notify you to write your journal' : '日記を書くよう通知する';
