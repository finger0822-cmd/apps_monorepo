...
import 'package:pulse_app/features/pulse/data/mappers/daily_state_mapper.dart';
...
/// [DailyStateRepository] の実装。core_state の [StateRepository] に委譲し、
/// domain [DailyState] と [DailyStateEntry] を mapper で変換する。
