...
const PulseLogEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'energy': PropertySchema(id: 2, name: r'energy', type: IsarType.long),
    r'entryId': PropertySchema(id: 3, name: r'entryId', type: IsarType.string),
    r'fatigue': PropertySchema(id: 4, name: r'fatigue', type: IsarType.long),
    r'focus': PropertySchema(id: 5, name: r'focus', type: IsarType.long),
    r'mood': PropertySchema(id: 6, name: r'mood', type: IsarType.long),
...
PulseLogEntity _pulseLogEntityDeserialize(
  ...
  object.id = id;
  object.mood = reader.readLongOrNull(offsets[6]);
  object.note = reader.readStringOrNull(offsets[7]);
  object.sleepiness = reader.readLongOrNull(offsets[8]);
...
extension PulseLogEntityQueryFilter
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterFilterCondition>
  fatigueGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterFilterCondition>
  fatigueLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterFilterCondition>
  focusGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterFilterCondition>
  focusLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
  ...
  sleepinessIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'sleepiness'),
      );
    });
  }
  ...
  sleepinessIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'sleepiness'),
      );
    });
  }

  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterFilterCondition>
  sleepinessEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterFilterCondition>
  sleepinessLessThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension PulseLogEntityQuerySortBy
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterSortBy> sortByMood() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mood', Sort.asc);
    });
  }

  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterSortBy> sortByMoodDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PulseLogEntityQuerySortThenBy
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterSortBy> thenByMood() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mood', Sort.asc);
    });
  }

  QueryBuilder<PulseLogEntity, PulseLogEntity, QAfterSortBy> thenByMoodDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'mood', Sort.desc);
    });
  }
...
extension PulseLogEntityQueryWhereDistinct
  ...
  QueryBuilder<PulseLogEntity, PulseLogEntity, QDistinct> distinctByMood() {
    return QueryBuilder.apply(this, (query) {
...
extension PulseLogEntityQueryProperty
  ...
  QueryBuilder<PulseLogEntity, int?, QQueryOperations> moodProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PulseLogEntity, int?, QQueryOperations> sleepinessProperty() {
    return QueryBuilder.apply(this, (query) {
