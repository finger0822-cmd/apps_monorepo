...
const IsarPulseEventEntitySchema = CollectionSchema(
  ...
  properties: {
    r'eventId': PropertySchema(id: 0, name: r'eventId', type: IsarType.string),
...
extension IsarPulseEventEntityByIndex on IsarCollection<IsarPulseEventEntity> {
  ...
  List<Id> putAllByEventIdSync(
    List<IsarPulseEventEntity> objects, {
    bool saveLinks = true,
  }) {
...
extension IsarPulseEventEntityQueryFilter
    on
        QueryBuilder<
          IsarPulseEventEntity,
          IsarPulseEventEntity,
          QFilterCondition
        > {
  QueryBuilder<
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  occurredAtUtcIsoEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  occurredAtUtcIsoStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'occurredAtUtcIso',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  occurredAtUtcIsoEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'occurredAtUtcIso',
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  occurredAtUtcIsoIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'occurredAtUtcIso', value: ''),
      );
    });
  }
  ...
  QueryBuilder<
    ...
    QAfterFilterCondition
  >
  occurredAtUtcIsoIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'occurredAtUtcIso', value: ''),
      );
    });
  }
...
extension IsarPulseEventEntityQueryObject
    on
        QueryBuilder<
          IsarPulseEventEntity,
          IsarPulseEventEntity,
...
extension IsarPulseEventEntityQueryLinks
    on
        QueryBuilder<
          IsarPulseEventEntity,
          IsarPulseEventEntity,
...
extension IsarPulseEventEntityQueryProperty
    on
        QueryBuilder<
          IsarPulseEventEntity,
          IsarPulseEventEntity,
